...
@Component({
  ...
  templateUrl: '../repartidor-create/repartidor-create.component.html',
  styleUrls: ['../repartidor-create/repartidor-create.component.scss']
  // templateUrl: './repartidor-edit.component.html',
  // styleUrls: ['./repartidor-edit.component.scss']
})
export class RepartidorEditComponent implements OnInit {
  public title: string;
  public user: User;
